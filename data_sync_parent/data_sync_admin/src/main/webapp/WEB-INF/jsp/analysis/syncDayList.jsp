					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>天数据分析</div>
							...
							<div class="portlet-body">
								...
								<br/>
								<!-- 报表 begin-->
								<div id="day_container" style="height:400px"></div>
								<script type="text/javascript">
								
								$(function () {
									var time =new Date().toLocaleDateString()+" - "+new Date().toLocaleDateString();
									$("#create_time").val(time);
									bulidxAxisArr(time);
									binddaterangepickerByTerm("#create_time","YYYY-MM-DD",false);
									
									$("#search_notices").click(function(){
										search();
									});
									daytimer=setInterval(search,10000); 
								});
									function search(){
								...
								function bulidSeries(xAxisArr,time){
									...
									$.ajax({
										type: "post",
										url:  'iSyncDay/querySyncHourDataList.do',
										data: {sync_time:time},
										dataType: "json",
										success: function(data){
											$(data).each(function(i,item){
											...
											//曲线图渲染
											CommonChart.curveChart('day_container','天同步数量',xAxisArr,seriesArr)
										},
										error:function(data){
										}
									});
