...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                $(".page-sidebar>ul>li>ul li").removeClass('open');
                $(".page-sidebar>ul>li>ul li").removeClass('active');
				...
				array.push($(this).attr("aname"));
				arrayurl.push($(this).attr("aurl"));
				var pa=$(this).parent().parent().prev("a");
				if(pa.is("a")){
					array.push(pa.attr("aname"));
					arrayurl.push(pa.attr("aurl"));
					var ppa=pa.parent().parent().prev("a");
					if(ppa.is("a")){
						array.push(ppa.attr("aname"));
						arrayurl.push(ppa.attr("aurl"));
					}
				}
				var html="";
				if(array.length==1){
					html+="<li>";
					html+="<a href='javascript:;' onclick='jumppage('"+arrayurl[0]+"')'>"+array[0]+"</a> ";
					html+="</li>";
				}else if(array.length==2){
					html+="<li>";
					html+="<a href='javascript:;' onclick='jumppage('"+arrayurl[1]+"')'>"+array[1]+"</a> ";
					...
					html+="<li>";
					html+="<a href='javascript:;' onclick='jumppage('"+arrayurl[2]+"')'>"+array[2]+"</a> ";
					html+="<i class='icon-angle-right'></i>";
					html+="</li>";
					html+="<li>";
					html+="<a href='javascript:;' onclick='jumppage('"+arrayurl[1]+"')'>"+array[1]+"</a> ";
                ...
                if (sub.is(":visible")) {
                    ...
                    jQuery(this).remove("apan[class='selected']");
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "media/css/themes/" + color + ".css");
