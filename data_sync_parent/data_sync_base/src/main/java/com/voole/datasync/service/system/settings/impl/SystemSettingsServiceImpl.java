...
import com.voole.datasync.entry.sytem.settings.SystemSettingsEntry;
import com.voole.datasync.mapper.system.settings.ISystemSettingsMapper;
import com.voole.datasync.service.system.settings.ISystemSettingsService;
import com.voole.datasync.vo.system.settings.SystemSettingsVo;
...
public class SystemSettingsServiceImpl implements ISystemSettingsService {
	 ...
	 * @return
	 * 
	 * @see com.voole.cdcenter.service.system.settings.ISystemSettingsService#getSystemSettings()
	 */
	@Override
	 ...
	 * @return
	 * 
	 * @see com.voole.cdcenter.service.system.settings.ISystemSettingsService#querySystenSettings(com.voole.cdcenter.vo.
	 ...
	 * 
	 * @see
	 * com.voole.cdcenter.service.system.settings.ISystemSettingsService#querySystenSettingsCount(com.voole.cdcenter.vo.
	 * system.settings.SystemSettingsVo)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.voole.cdcenter.service.system.settings.ISystemSettingsService#updateSystemSettings(com.voole.cdcenter.entry.
	 ...
	 * 
	 * @see
	 * com.voole.cdcenter.service.system.settings.ISystemSettingsService#insertSettings(com.voole.cdcenter.entry.sytem.
