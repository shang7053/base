...
out.print("初进页面时获取参数："+session.getAttribute("teststr"));
out.print("添加一个属性");
session.setAttribute("teststr","haah");

 %>
 
 <a href="http://localhost:8082/sessionmonitor/sessiontest.jsp" target="_blank">sessionmonitor</a>