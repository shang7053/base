...
<script type="text/javascript" src="media/js/highcharts/highstock.js"></script>
<script type="text/javascript" src="media/js/highcharts/exporting.js"></script>
<script type="text/javascript" src="media/js/highcharts/highcharts-zh_CN.js"></script>
<script type="text/javascript" src="media/js/highcharts/drilldown.js"></script>
			...
			if("javascript:;"!=furl&&"javascript:void(0);"!=furl){
				if(furl.indexOf("https://")>-1||furl.indexOf("http://")>-1){
					...
					$("#dashboard").load(furl,function(responseTxt,statusTxt,xhr){
					   if(statusTxt=="success"&&responseTxt.length!=251){
					    	return;
					   }else if(statusTxt=="success"&&responseTxt.length==251){
