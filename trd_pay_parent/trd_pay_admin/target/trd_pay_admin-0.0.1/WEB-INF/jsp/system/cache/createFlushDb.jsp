...
<form id="create_flushdb_form" action="javascript:;">
 
 	<table style="width: 100%;">
 		<tr>
 			<td><lable>上次ping通时间</lable></td>
 			<td><input type="text" name="last_ping_date" id="last_ping_date"/></td>
 			<td></td>
 		</tr>
 		
 		<tr>
 			<td><lable>间隔时间失效时间</lable></td>
 			<td><input type="text" name="flush_cache_interval" /></td>
 			<td></td>
 		</tr>
 		<tr>
...
$(function () {
	...
	$("#last_ping_date").val(time);
	binddaterangepickerByTermlyj("#last_ping_date","YYYY-MM-DD HH:mm:ss",true);
})
