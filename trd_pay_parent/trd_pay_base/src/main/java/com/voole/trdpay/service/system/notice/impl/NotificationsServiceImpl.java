package com.voole.trdpay.service.system.notice.impl;
...
import com.voole.trdpay.mapper.system.notice.INotificationsMapper;
...
public class NotificationsServiceImpl implements INotificationsService {
	...
	/*
	 * (非 Javadoc) <p>Title: setAllRead</p> <p>Description: </p>
	 * 
	 * @param notificationsEntry
	 * 
	 * @return
	 * 
	 * @see
	 * com.voole.datasync.service.system.notice.INotificationsService#setAllRead(com.voole.datasync.entry.sytem.notice.
	 * NotificationsEntry)
	 */
	@Override
	public Boolean setAllRead(NotificationsEntry notificationsEntry) {
		return this.notificationsMapper.setAllRead(notificationsEntry) > 0;
	}
